      ...
      <div className="max-w-[1200px] mx-auto w-full px-6 md:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center h-full min-h-[100dvh] pt-24 lg:pt-0">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center items-center lg:items-start text-center lg:text-left order-1 h-full">
          ...
          >
            ...
            <motion.div variants={textVariants} className="mb-6 inline-flex items-center gap-2 py-1.5 px-4 rounded-full border border-gray-100 bg-gray-50/50 backdrop-blur-md cursor-default">
        ...
        <div className="lg:col-span-6 relative h-[50vh] md:h-[60vh] lg:h-full w-full flex items-end lg:items-center justify-center lg:justify-center order-2">
          ...
          >
             <Image
              ...
              fill
              className="object-contain object-bottom lg:object-center drop-shadow-2xl"
              priority
