...
export default function IpadPage() {
  const ipadProducts = products.filter((p) => p.category === "ipad");
    ...
    <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-[#f5f5f7] min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16 text-center md:text-left">
           <span className="text-purple-600 font-bold tracking-widest uppercase text-[10px] mb-2 block">
             Inspiración
           </span>
           ...
           <p className="text-xl text-gray-500 max-w-2xl font-medium mx-auto md:mx-0">
             Tu próxima computadora no es una computadora. Versatilidad total en tus manos.
           </p>
        </div>
           ...
           {ipadProducts.map((product) => (
              ...
              >
                <div className="mb-6 z-10">
                   <span className="inline-block px-3 py-1 rounded-full bg-purple-50 text-purple-600 text-[10px] font-bold uppercase tracking-widest mb-3">
                     Creatividad
                   </span>
