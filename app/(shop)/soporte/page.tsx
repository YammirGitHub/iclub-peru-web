  ...
  const services = [
    {
      ...
      icon: (
        <Smartphone
          strokeWidth={1}
          className="w-24 h-24 text-gray-300 group-hover:text-[#0071e3] transition-colors"
        />
      ),
    },
    {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16 text-center md:text-left">
          ...
          <p className="text-xl text-gray-500 max-w-2xl font-medium mx-auto md:mx-0">
            Expertos certificados. Repuestos originales y garantía real para
            revivir tu equipo.
          </p>
        </div>
          ...
          {services.map((service) => (
            ...
            >
              <div className="mb-6 z-10">
                ...
                <h3 className="text-3xl font-semibold text-[#1d1d1f] mb-2 tracking-tight">
                  {service.name}
                </h3>
